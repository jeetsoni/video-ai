...
export const SFX_AMBIENT_ASSETS: SfxAssetDefinition[] = [
  {
    ...
    prompt: "Curious upbeat ambient pad with gentle plucked texture and light forward momentum, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Warm friendly ambient pad with soft piano-like texture and gentle evolving tone, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Minimal clean ambient hum with soft air and subtle neutral tone, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Calm soft ambient pad with gentle warm tone and very subtle airy texture, clean and minimal, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.3,
  },
  {
    ...
    prompt: "Focused bright ambient tone with gentle clarity and clean high-end shimmer, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Balanced neutral ambient bed with subtle alternating stereo movement and clean tone, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Confident steady ambient pad with warm building undertone and modern clean texture, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
  {
    ...
    prompt: "Uplifting warm ambient resolution with gentle positive shimmer and soft fade, seamless loop",
    durationSeconds: 10,
    promptInfluence: 0.5,
  },
];
...
export const SFX_TRANSITION_ASSETS: SfxAssetDefinition[] = [
  {
    ...
    prompt: "Clean quick forward swoosh with light modern texture and short tail",
    durationSeconds: 1.5,
    promptInfluence: 0.7,
  },
  {
  ...
  },
  {
    ...
    prompt: "Quick digital transition blip with clean electronic texture and short decay",
    durationSeconds: 1.5,
    promptInfluence: 0.7,
  },
  {
  ...
  },
  {
    ...
    prompt: "Short rising tone building to a clean bright peak with quick resolve",
    durationSeconds: 2,
    promptInfluence: 0.7,
  },
  {
    ...
    prompt: "Warm confident resolve tone with gentle positive character and clean ending",
    durationSeconds: 1.5,
    promptInfluence: 0.7,
  },
];
...
export const SFX_UTILITY_ASSETS: SfxAssetDefinition[] = [
  {
    ...
    prompt: "Short subtle pop for text appearing on screen with clean digital character",
    durationSeconds: 0.5,
    promptInfluence: 0.7,
  },
  {
    ...
    prompt: "Quick smooth slide sound with soft material movement and clean stop",
    durationSeconds: 0.8,
    promptInfluence: 0.7,
  },
  {
  ...
  },
  {
    ...
    prompt: "Gentle soft ambient fade dissolving to silence with warm reverb tail",
    durationSeconds: 2,
    promptInfluence: 0.7,
  },
];
...
export const ALL_SFX_FILENAMES: string[] = ALL_SFX_ASSETS.map((a) => a.filename);
